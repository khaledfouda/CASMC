...
The term $H^*UD = (I_n-H)A$ corresponds to the residuals from fitting the covariates $X$ to $A$. That is, they are the residuals of the model $A = \beta_A X + \epsilon_A$
