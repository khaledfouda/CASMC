...
## NEW: Comparing the performance of the second model (call it Beta-Impute) compared to the original Soft-Impute model.
...
for(b in 1:B){
   ...
   start_time <- Sys.time()
   fit = simpute.als.splr.fit.beta(Y, X_r$X,  X_r$rank, maxit=500,
