...
file_list <- list.files(path = path_to_data, pattern =
                           paste0("((Compare_MC_Models_Youssef_Simulation_with_replications_",note,
                                  "[0-9]+.*)|(Compare_MC_Models_Mao_Simulation_with_replications",note,"))\\.csv$"),
...
print_table <-
   function(results,
      ...
      error_columns <- c("O_test", "O", "beta", "M", "time")
