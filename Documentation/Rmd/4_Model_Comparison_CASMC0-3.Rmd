...
print_table <-
   function(results,
      ...
      rename(in_sparse = sparse_in_sparse,
             in_nonsparse = sparse_in_nonsparse) |> 
         mutate_if(is.numeric, function(x)
            replace_na(as.character(round(x, 3)), '')) %>%
...
read_csv("saved_data/June18/Model_Comparison_simulation_replications__1_.csv", show_col_types = F) |> 
   print_table(caption = "Case 1")
```


```{r fig.height=15, fig.width=15, results='asis', eval=T, echo=F}
read_csv("saved_data/June18/Model_Comparison_simulation_replications__2_.csv", show_col_types = F) |> 
...
```{r fig.height=15, fig.width=15, results='asis', eval=T, echo=F}
read_csv("saved_data/June18/Model_Comparison_simulation_replications__3_.csv", show_col_types = F) |> 
...
```{r fig.height=15, fig.width=15, results='asis', eval=T, echo=F}
read_csv("saved_data/June18/Model_Comparison_simulation_replications__4_.csv", show_col_types = F) |> 
