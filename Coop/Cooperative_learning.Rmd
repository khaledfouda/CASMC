...
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,5,1e-3,1,alpha_grid = c(1))
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,5,1e-3,0.5,alpha_grid = c(1))
