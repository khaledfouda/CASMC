...
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,10,1e-3,1,alpha_grid = c(1),numCores=1)
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,20,1e-3,0.9,alpha_grid = c(1),numCores=1)
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,20,1e-3,0.7,alpha_grid = c(1),numCores=1)
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,10,1e-3,0.5,alpha_grid = c(1),numCores=1)
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,10,1e-3,0.3,alpha_grid = c(1),numCores=1)
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,10,1e-3,0.01,alpha_grid = c(1),numCores=1)
...
```{r code=readLines(paste0(path_to_code, "/Youssef_Mao_Coop_Results.txt"))}
...
```{r test2, eval=TRUE}
gen.dat <- generate_simulation_data_ysf(1,400,400,5,10, missing_prob =0.8 ,coll=TRUE)

A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,20,1e-6,1,alpha_grid = c(1),numCores=1)
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,20,1e-6,0.9,alpha_grid = c(1),numCores=1)
A.hat <- Mao_Coop_fit(gen.dat$A, gen.dat$X, gen.dat$Z, gen.dat$W,20,1e-6,0.7,alpha_grid = c(1),numCores=1)
```
