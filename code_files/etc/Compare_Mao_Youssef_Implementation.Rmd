...
color_min_values <- function(data, columns) {
  ...
  for (col_name in columns) {
    ...
    data[[col_name]] <- cell_spec(ifelse(data[[col_name]]== 9999,'',colrounded), "html", color = ifelse(data[[col_name]]== 9999, "grey98", "black"),
...
print_table <- function(results, missing=FALSE, prob=NA, caption=""){
   ...
   sim_results$simpute.lambda.2 = 9999
   sim_results$simpute.alpha = 9999
   simcov_results$simputeCov.lambda.2 = 9999
